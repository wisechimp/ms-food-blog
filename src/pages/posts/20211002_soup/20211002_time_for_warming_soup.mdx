...
imageSrc: soup2.jpg
tags: ["soup", "winter squash", "recipe"]
author: Ma Sharp
---
...
Note: no worries if you do not have a blender. A handheld device will also work nicely. Alternatively, I would simple cut the squash finely and then use a fork to mash some of the squash (remember it will be quite soft, so should be okay). The blender will give the smoothest result, which I prefer for this soup, but the alternatives will still be very nice.